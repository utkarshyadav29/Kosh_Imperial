...
export const products: Product[] = [
  ...
  { id:2, name:"Slim Wallet", price:1299, original:1499, note:"Light. Minimal. Everyday.", category:"Wallets", image:"https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=1000&q=88", details:"A feather-light silhouette for the essentials, with a soft hand feel and a clean, pocket-ready profile." },
  { id:3, name:"Card Holder", price:899, original:999, note:"Compact. Smart. Essential.", category:"Essentials", image:"https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=1000&q=88", details:"A compact card holder designed for people who carry less, but care more about how it is made." },
  { id:4, name:"Zip Wallet", price:1699, original:1899, note:"Secure. Spacious. Reliable.", category:"Wallets", image:"https://images.unsplash.com/photo-1612902456551-333ac5afa26e?auto=format&fit=crop&w=1000&q=88", details:"A zip-around companion with room for your daily rhythm, shaped in tactile eco-craft leather." },
  { id:5, name:"Travel Wallet", price:1899, original:2099, note:"Organized. For every journey.", category:"Travel", image:"https://images.unsplash.com/photo-1585488433055-ff9d1e2c5a9d?auto=format&fit=crop&w=1000&q=88", details:"Passport-ready storage and a calm, considered layout for departures, arrivals, and everything between." },
  { id:6, name:"Coin Pouch", price:699, original:799, note:"Small in size. Big on purpose.", category:"Essentials", image:"https://images.unsplash.com/photo-1594223274512-ad4803739b7c?auto=format&fit=crop&w=1000&q=88", details:"A petite piece for coins, keepsakes, and the tiny things that deserve a home of their own." },
  { id:7, name:"Key Loop", price:499, original:599, note:"A small ritual, made well.", category:"Accessories", image:"https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format&fit=crop&w=1000&q=88", details:"A tactile key loop that brings the KOSH material story into your everyday carry." },
  { id:8, name:"Passcase Bifold", price:1599, original:1799, note:"Two essentials, one quiet form.", category:"Travel", image:"https://images.unsplash.com/photo-1556740749-887f6717d7e4?auto=format&fit=crop&w=1000&q=88", details:"A passport and card companion designed for a lighter, more thoughtful journey." },
];
const formatPrice=(p:number)=>`₹ ${p.toLocaleString("en-IN")}`;

export default function Home(){
 const [,navigate]=useLocation(); const [selected,setSelected]=useState<Product|null>(null); const [cart,setCart]=useState<Product[]>([]); const [cartOpen,setCartOpen]=useState(false); const [toast,setToast]=useState(""); const [favorites,setFavorites]=useState<number[]>([]); const [searchOpen,setSearchOpen]=useState(false); const [menuOpen,setMenuOpen]=useState(false);
 useEffect(()=>{document.body.style.overflow=selected||cartOpen||menuOpen?"hidden":""; return()=>{document.body.style.overflow=""}},[selected,cartOpen,menuOpen]); useEffect(()=>{if(!toast)return;const t=setTimeout(()=>setToast(""),2400);return()=>clearTimeout(t)},[toast]);
